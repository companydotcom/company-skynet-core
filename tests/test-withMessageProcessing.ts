...
// Sample event for bulk test
// const sampleSQSEvent = {
//   version: '0',
//   id: '49d4e939-eab2-b34e-a3b9-377c17e4904a',
//   'detail-type': 'Scheduled Event',
//   source: 'aws.events',
//   account: '765342366425',
//   time: '2024-07-26T17:16:33Z',
//   region: 'us-east-1',
//   resources: [
//     'arn:aws:events:us-east-1:765342366425:rule/website-weebly-devx-BulkTransitionEventsRuleSchedu-1HYGOG984T3B3',
//   ],
//   foo: 'bar',
//   detail: {},
// };
// Sample event for direct tranistion
const sampleSQSEvent = {
  Records: [
    {
      EventSource: 'aws:sns',
...
const test = async (event: any) => {
  ...
  middifiedHandler.use({
    ...
    after: async (request) => {
      console.log('Inside with message processing after');
      console.log(JSON.stringify(request.internal, null, 4));
    },
  });

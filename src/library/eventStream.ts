...
//   interface CompanyEventAttributes {
//     emitter: MessageAttributeValue<string>;
//     eventId: MessageAttributeValue<string>;
//     triggerEventId: MessageAttributeValue<string>;
//     entity: MessageAttributeValue<string>;
//     entityId: MessageAttributeValue<string>;
//     operation: MessageAttributeValue<'C' | 'R' | 'U' | 'D'>;
//     status: MessageAttributeValue<'trigger' | 'pass' | 'fail'>;
//     eventType: MessageAttributeValue<string>;
// }

interface CompanyEventAttributesUnParsed {
  emitter: string;
  eventId: string;
 ...
 * @param {any} type
 */
const parseSnsType = (val: any, type: string) =>
  isSnsString(type) ? val : JSON.parse(val);
...
export default {
  ...
  publish: async (
    ...
    try {
      ...
      const command = new AWS.snsClient.PublishCommand(params);

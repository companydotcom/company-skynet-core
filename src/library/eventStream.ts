...
// interface MessageAttribute<T = string> {
//   DataType: string;
//   StringValue: T;
// }
// interface CompanyEventAttributes {
//   emitter: MessageAttribute<string>;
//   eventId: MessageAttribute<string>;
//   triggerEventId: MessageAttribute<string>;
//   entity: MessageAttribute<string>;
//   entityId: MessageAttribute<string>;
//   operation: MessageAttribute<'C' | 'R' | 'U' | 'D'>;
//   status: MessageAttribute<'trigger' | 'pass' | 'fail'>;
// }
...
//     topicArn: string,
//     message: any,
//     attributes: CompanyEventAttributes = {} as CompanyEventAttributes,
//     options: object = {}
//   ) => {
